...
import { createReview } from "@/store/cards.slice"
...
function CreateReview() {
    ...
    function onSubmit(values: TCreateCardForm) {
        ...
        dispatch(createReview(values)).then((r) => {
    ...
    return <Form {...form}>
        <h1 className="text-[24px] font-bold p-2">Create restaurant review</h1>
...
export default BusinessGuard(CreateReview)